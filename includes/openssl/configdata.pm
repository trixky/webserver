...
our %unified_info = (
    ...
    "dirinfo" => {
        ...
        "crypto/serializer" => {
            "deps" => [
                ...
                "crypto/serializer/libcrypto-shlib-serializer_err.o",
                "crypto/serializer/libcrypto-shlib-serializer_lib.o",
                "crypto/serializer/libcrypto-shlib-serializer_meth.o",
                "crypto/serializer/libcrypto-shlib-serializer_pkey.o"
            ],
            "products" => {
                "lib" => [
                    "libcrypto"
    ...
    "sources" => {
        ...
        "test/cmp_msg_test" => [
            "test/cmp_msg_test-bin-cmp_status_test.o",
            "test/cmp_msg_test-bin-cmp_testlib.o"
        ],
        "test/cmp_msg_test-bin-cmp_status_test.o" => [
        ...
        "test/cmp_protect_test" => [
            "test/cmp_protect_test-bin-cmp_status_test.o",
            "test/cmp_protect_test-bin-cmp_testlib.o"
        ],
        "test/cmp_protect_test-bin-cmp_status_test.o" => [
            "test/cmp_status_test.c"
...
unless (caller) {
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '/Users/trixky/Documents/tls/openssl/util/perl';
        use OpenSSL::fallback '/Users/trixky/Documents/tls/openssl/external/perl/MODULES.txt';
        use OpenSSL::Template;

        my $prepend = <<"_____";
use File::Spec::Functions;
use lib '/Users/trixky/Documents/tls/openssl/util/perl';
use lib '/Users/trixky/Documents/tls/openssl/Configurations';
use lib '.';
use platform;
_____
